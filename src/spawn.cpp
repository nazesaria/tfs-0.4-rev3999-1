...
bool  Spawn::spawnMonster(uint32_t spawnId, MonsterType* mType, const Position& pos, Direction dir, int16_t t, bool startup /*= false*/)
{
   ...
   if(startup)
    ...
    else if (t == 0)
    {
        ...
        g_game.addMagicEffect(pos, g_config.getNumber(ConfigManager::EFFECT_SPAWN));
